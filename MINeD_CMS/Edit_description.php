...
<center><form action='Edit_description.php' method='POST' enctype='multipart/form-data' class='md-form'>
		<h4>	
			<textarea  class='a' name='edit' placeholder='Write something....' required></textarea>
...
{	
	@$t = $_SESSION['email'];
	@$q1 = mysqli_query($connect , "UPDATE `ngo_details` SET `description`= '$desc' WHERE `email` ='$t' AND `Permission`='1'");
