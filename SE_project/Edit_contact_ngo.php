...
";
@$t1 = $_SESSION['email'];
@$query2 = mysqli_query($connect,"SELECT * FROM `ngo_details` WHERE `email`='$t1' AND `Permission`='1'");
...
{	
	@$t = $_SESSION['email'];
	@$q1 = mysqli_query($connect , "UPDATE `ngo_details` SET `person_name`= '$tname' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("Contact info updated Succesfully");
...
{
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `temail`= '$e1' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
...
if(@$submit3)
{
	...
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `temail`= '$e2' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
		location="Edit_contact_ngo.php";
		</script>';
...
{
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `id1`= '$e3' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
...
if(@$id13 && @$e3)
{
	@$f = "NA";
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `id1`= '$f' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
...
{
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `id2`= '$e4' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("Email added Successfully");
		location="Edit_contact_ngo.php";
		</script>';
...
if(@$id23 && @$e4)
{
	@$f = "NA";
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `id2`= '$f' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("Email deleted Successfully");
		location="Edit_contact_ngo.php";
		</script>';
...
{
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `c1`= '$e5' WHERE `email` ='$t' AND `Permission`='1' AND `Permission`='1' AND `Permission`='1'");
			echo '<script type="text/javascript">
...
{
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `c1`= '$e5' WHERE `email` ='$t' AND `Permission`='1' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("contact Updated Successfully");
		location="Edit_contact_ngo.php";
		</script>';
...
if(@$num13 && @$e5)
{
	@$f = "0000000000";
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `c1`= '$f' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("contact Updated Successfully");
		location="Edit_contact_ngo.php";
		</script>';
...
{
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `c2`= '$e6' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("contact Updated Successfully");
		location="Edit_contact_ngo.php";
		</script>';
...
if(@$num23 && @$e6)
{
	@$f = "0000000000";
	@$t = $_SESSION['email'];
	@$q2 = mysqli_query($connect , "UPDATE `ngo_details` SET `c2`= '$f' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
			alert("contact Updated Successfully");
		location="Edit_contact_ngo.php";
		</script>';
...
{	
	@$t = $_SESSION['email'];
	@$q1 = mysqli_query($connect , "UPDATE `ngo_details` SET `address`= '$nadd' WHERE `email` ='$t' AND `Permission`='1'");
			echo '<script type="text/javascript">
